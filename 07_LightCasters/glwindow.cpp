...
void GLWindow::initializeGL() {
    ...
    m_cubeShader.initShader("../../07_LightCasters/shader/vert_box.glsl", "../../07_LightCasters/shader/frag_box.glsl");
    m_sunShader.createShader();
    m_sunShader.initShader("../../07_LightCasters/shader/vert_sun.glsl", "../../07_LightCasters/shader/frag_sun.glsl");
}
...
//    light_color = glm::vec3((float)timer.elapsed() * 0.8f, (float)timer.elapsed() * 0.5f, (float)timer.elapsed() * 0.7f);
    ...
    m_cubeShader.setUniformVec3(f, "myLight.m_specular", light_color * glm::vec3(0.8f)); // 0.5f
